<?php
  require("../../config.php");
  $name = $_GET['name'];
  $rst = $con->prepare("SELECT * FROM qari2 WHERE name = ?");
  $rst->execute([$name]);
  $radio = $rst->fetchall();
  foreach($radio as $ra)
  {
...
<body class="bg-neutral-200 overflow-hidden" >
...
<div class="Loading absolute w-full h-full bg-gray-700 z-50 flex place-content-center place-items-center">
  ...
  <nav class="bg-gray-800">
        ...
        <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
          ...
          <div class="hidden sm:ml-6 sm:block">
            <div class="flex space-x-4">
              ...
              <a href="../" class="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Live Radio</a>
    ...
    <div class="sm:hidden hidden" id="mobile-menu">
      <div class="space-y-1 px-2 pt-2 pb-3">
        ...
        <a href="../" class="text-gray-300 hover:bg-gray-700 hover:text-white block px-3 py-2 rounded-md text-base font-medium">Live Radio</a>
  ...
  <div class="container w-full h-4/5 flex place-content-center place-items-center fixed  absolute left-2/4 top-2/4 -translate-x-1/2 -translate-y-1/2 -z-10">
    <div class="cont  w-98 bg-slate-800 rounded-lg shadow-lg drop-shadow-lg pointer flex justify-center items-center text-white h-12 fixed  transition duration-150 ease-out"><div class="play bg-slate-500 w-10 h-10 m-2 flex rounded-lg place-content-center place-items-center cursor-pointer"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M2 24v-24l20 12-20 12z"/></svg></div>
    <?php echo "<span class='id m-6 flex place-content-center place-items-center'>".$ra[0]."</span><span class='name mr-5 text-white text-base'>".$ra[1]."</span>";?>
    </div>
   </div>
   <div class="audio hidden">
        <?php echo "<audio src='".$ra[2]."' class='audio'></audio>";}?>
    </div>
